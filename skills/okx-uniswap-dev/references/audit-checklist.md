...
| Tier | Risk Score | Requirements |
|---|---|---|
| Self-Audit | 0-5 | Internal code review, full test coverage, static analysis |
| Peer Audit | 6-12 | + External developer review, extended fuzz testing |
| Professional Audit | 13-20 | + Security firm audit, bug bounty program |
| Multi-Audit | 21+ | + Multiple independent audits, formal verification |
