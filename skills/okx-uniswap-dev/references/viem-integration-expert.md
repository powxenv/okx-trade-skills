# Viem Integration Expert Reference

Deep expertise reference for viem and wagmi EVM blockchain integration — debugging, optimization, and best practices.
...
1. **Check Version Compatibility**: Ensure viem/wagmi versions are compatible with suggested APIs
...
const balance = await client
  .getBalance({ address: '0x...' as `0x${string}` })
  .catch((error) => {
...
- Full viem integration patterns: `viem-patterns.md`
