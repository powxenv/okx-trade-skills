...
const files = [
  ...
  {
    id: "xlayer-agent-auto",
    filename: "references/agent-automation.md",
    content: xlayerAgentAutomation,
  },
  {
    id: "xlayer-authentication",
    filename: "references/authentication.md",
    content: xlayerAuthentication,
  },
  {
    id: "xlayer-decision",
    filename: "references/decision-framework.md",
    content: xlayerDecisionFramework,
  },
  {
    id: "xlayer-keyword-glossary",
    filename: "references/keyword-glossary.md",
    content: xlayerKeywordGlossary,
  },
  {
    id: "xlayer-risk-framework",
    filename: "references/risk-framework.md",
    content: xlayerRiskFramework,
  },
  {
    id: "xlayer-risk-management",
    filename: "references/risk-management.md",
    content: xlayerRiskManagement,
  },
  {
    id: "xlayer-strategies",
    filename: "references/trading-strategies.md",
    content: xlayerStrategies,
  },
  {
    id: "xlayer-troubleshooting",
    filename: "references/troubleshooting.md",
    content: xlayerTroubleshooting,
  },
  {
    id: "xlayer-uniswap-integration",
    filename: "references/uniswap-integration.md",
    content: xlayerUniswapIntegration,
  },
  {
    id: "xlayer-workflow-buy",
    filename: "references/workflow-buy.md",
    content: xlayerWorkflowBuy,
  },
  {
    id: "xlayer-workflow-sell",
    filename: "references/workflow-sell.md",
    content: xlayerWorkflowSell,
  },
  {
    id: "xlayer-ws",
    filename: "references/ws-monitoring.md",
    content: xlayerWsMonitoring,
  },
  {
    id: "xlayer-xlayer",
    filename: "references/xlayer-strategies.md",
    content: xlayerXlayerStrategies,
  },
  { id: "xlayer-shared-header", filename: "_shared/", isHeader: true },
  {
    id: "xlayer-chain-support",
    filename: "_shared/chain-support.md",
    content: xlayerChainSupport,
  },
  {
    id: "xlayer-native-tokens",
    filename: "_shared/native-tokens.md",
    content: xlayerNativeTokens,
  },
  {
    id: "xlayer-preflight",
    filename: "_shared/preflight.md",
    content: xlayerPreflight,
  },
  { id: "xlayer-agents-header", filename: "agents/", isHeader: true },
  {
    id: "xlayer-openai",
    filename: "agents/openai.yaml",
    content: xlayerOpenai,
    isCode: true,
  },
] satisfies FileEntry[];
        ...
        <aside>
          <Tabs orientation="vertical">
            <ScrollShadow className="max-h-165 max-w-75 w-full shrink-0">
              <Tabs.ListContainer>
                <Tabs.List
                  aria-label="X Layer skill files"
